        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RankDiscount = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerRanks", x => x.RankId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountCategory = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_CustomerRanks_RankId",
                        column: x => x.RankId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Discount_Customers", x => new { x.CustomerId, x.DiscountId });
                    table.ForeignKey(
                        name: "FK_Discount_Customers_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Discount_Customers_Discounts_DiscountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodImages_Menus_MenuId",
                        column: x => x.MenuId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodSizes", x => x.FoodSizeId);
                    table.ForeignKey(
                        name: "FK_FoodSizes_Menus_MenuId",
                        column: x => x.MenuId,
                        principalTable: "Menus",
                        principalColumn: "MenuId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Revenue_Orders", x => new { x.RevenueId, x.OrderId });
                    table.ForeignKey(
                        name: "FK_Revenue_Orders_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Revenue_Orders_Revenues_RevenueId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cart_Menus", x => new { x.CartId, x.FoodSizeId });
                    table.ForeignKey(
                        name: "FK_Cart_Menus_Carts_CartId",
                        column: x => x.CartId,
                        principalTable: "Carts",
                        principalColumn: "CartId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cart_Menus_FoodSizes_FoodSizeId",
                        column: x => x.FoodSizeId,
                        principalTable: "FoodSizes",
                        principalColumn: "FoodSizeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventories_FoodSizes_FoodSizeId",
                        column: x => x.FoodSizeId,
                        principalTable: "FoodSizes",
                        principalColumn: "FoodSizeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Menu_Orders", x => new { x.FoodSizeId, x.OrderId });
                    table.ForeignKey(
                        name: "FK_Menu_Orders_FoodSizes_FoodSizeId",
                        column: x => x.FoodSizeId,
                        principalTable: "FoodSizes",
                        principalColumn: "FoodSizeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Discount_Customers_DiscountId",
                table: "Discount_Customers",
                column: "DiscountId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodImages_MenuId",
                table: "FoodImages",
                column: "MenuId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodSizes_MenuId",
                table: "FoodSizes",
                column: "MenuId");

            migrationBuilder.CreateIndex(
                name: "IX_Inventories_FoodSizeId",
                table: "Inventories",
                column: "FoodSizeId");

            migrationBuilder.CreateIndex(
                name: "IX_Menu_Orders_OrderId",
                table: "Menu_Orders",
                column: "OrderId");
